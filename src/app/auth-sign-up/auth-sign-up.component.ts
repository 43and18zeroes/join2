...
export class AuthSignUpComponent implements OnInit {
  ...
  // private colors: string[] = [
  //   '#003366', '#004080', '#00509E', '#0055A4', '#005FB3',
  //   '#006633', '#007040', '#007B4F', '#008060', '#008755',
  //   '#8B0000', '#9B111E', '#A31220', '#A92328', '#B22222',
  //   '#800080', '#872657', '#8B008B', '#93218E', '#992E92',
  //   '#00CED1', '#20B2AA', '#40E0D0', '#48D1CC', '#5F9EA0',
  //   '#FF4500', '#FF6347', '#FF7F50', '#FF8C00', '#FFA07A',
  //   '#DAA520', '#D2B55B', '#CC9900', '#C7A317', '#C2A22B',
  //   '#003B6F', '#00428A', '#004DA1', '#0052B1', '#005BC3',
  //   '#006F42', '#007A58', '#008269', '#008C7A', '#009688',
  //   '#9B1B1E', '#A51821', '#AF1F27', '#B92B2E', '#C33A3A',
  //   '#872272', '#8E2D80', '#952D8A', '#9C3193', '#A43B9D',
  //   '#10D3D1', '#30DAC2', '#40DFB3', '#58E5A0', '#66EB90',
  //   '#FF5010', '#FF6C38', '#FF8245', '#FF9955', '#FFAF68',
  //   '#DAB015', '#DABD30', '#D9C742', '#DAC952', '#DADD63',
  //   '#004380', '#004B95', '#0055A5', '#0060B5', '#006CC8',
  //   '#007850', '#008365', '#009079', '#009D90', '#00B0A2',
  //   '#A52229', '#B02E31', '#BC3C3C', '#C84848', '#D35959',
  //   '#903290', '#97389A', '#A140A5', '#A946AF', '#B250BA',
  //   '#50E8B0', '#64EC9F', '#78EF8F', '#8CF280', '#A0F672',
  //   '#FFAA20', '#FFB43A', '#FFBF50', '#FFCA68', '#FFD77F'
  // ];
